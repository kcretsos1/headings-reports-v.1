...
-->
		<?php
			...
			$filename = "queries/subject_titles.sql"; //SQL file
			$baseURL = "subject_titles.php"; //PHP file
		?>
...
<div class="d-flex" id="wrapper">
   ...
   <h5>Subject Indexed - Title Headings Report</h5>


   <form action="subject_titles.php">
      <select name="m">
