...
-->
		<?php
			...
			$filename = "queries/author_Diff.sql"; //SQL file
			$baseURL = "author_Diff.php"; //PHP file
		?>
...
<div class="d-flex" id="wrapper">
   ...
   <h5>Author Indexed - Differentiated Name Headings Report</h5>


   <form action="author_Diff.php">
      <select name="m">
