...
-->
		<?php
			...
			require('functions/blind_functions.php'); //Functions
			ini_set('memory_limit', '1024M'); //increase memory limit if needed	
			$filename = "queries/blind_headings.sql"; //SQL file
			$baseURL = "blind_headings.php"; //PHP file
		?>
...
<div class="d-flex" id="wrapper">
   ...
   <h5>Blind Headings Report</h5>


   <form action="blind_headings.php">
      <select name="m">
