...
-->
		<?php
			...
			$filename = "queries/title_headings.sql"; //SQL file
			$baseURL = "title_headings.php"; //PHP file
		?>
...
<div class="d-flex" id="wrapper">
   ...
   <h5>Title Indexed - Title Headings Report</h5>


   <form action="title_headings.php">
      <select name="m">
