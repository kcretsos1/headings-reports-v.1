...
-->
		<?php
			...
			$filename = "queries/subject_names_Undiff.sql"; //SQL file
			$baseURL = "subject_names_Undiff.php"; //PHP file
		?>
...
<div class="d-flex" id="wrapper">
   ...
   <h5>Subject Indexed - Differentiated Name Headings Report</h5>


   <form action="subject_names_Undiff.php">
      <select name="m">
